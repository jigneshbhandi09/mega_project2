...
def main():
    # List of tickers
    ticker_options = [
        "BAJAJ ELECTRICALS LTD","BAJAJ HINDUSTHAN SUGAR LTD","BAJAJ FINANCE LTD",
        "BAJAJ HOLDINGS & INVESTMENT LTD","BAJAJ STEEL LTD",
        "BAJAJ AUTO LTD	","BAJAJ FINSERV LTD","BAJAJ CONSUMER CARE LTD",
